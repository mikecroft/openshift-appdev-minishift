...
ocn create -f templates/nexus/nexus-data.yml
ocn create -f templates/nexus/nexus-dc.yml
ocn create -f templates/nexus/nexus-route.yml
ocn create -f templates/nexus/nexus-registry-service.yml
ocn create -f templates/nexus/nexus-registry-route.yml
ocn create -f templates/nexus/nexus-service.yml
